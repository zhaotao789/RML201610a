...
train_X=np.load('通信调制/训练集/X_train.npy')
train_Y=np.load('通信调制/训练集/Y_train.npy')
test_X=np.load('通信调制/测试集/X_test.npy')
# 将第二、三维转换为16x16
train_X = train_X.reshape(train_X.shape[0],1, 16, 16)
test_X = test_X.reshape(test_X.shape[0],1, 16, 16)
